### Singleton
#### Khái niệm
* Là một trong nhóm Creational, nó sẽ đảm bảo duy nhất một thể hiện được tạo, hay còn có thể giải thích là xuyên suốt quá trình hoạt động của ứng dụng chỉ có duy nhất một đối tượng được tạo ra từ một class.

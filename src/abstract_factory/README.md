...
* Tưởng tượng như một tập đoàn hay một công ty lại có nhiều công ty con.
#### Các thành phần của Abstract Factory Method
* AbstractFactory: Là một interface hoặc abstract class chứa các phương thức tạo ra các đối tượng abstract.
* ConcreteFactory (sub factory): cài đặt các phương thức để tao ra các đối tượng cụ thể.
* AbstractProduct (supper-class) : là dạng interface hoặc abstract class để định nghĩa ra đối tượng cha hay đối tượng abstract.
* Product (sub-class): là các đối tượng cụ thể cài đặt các method từ AbstractProduct.
